...
from NeuralCFmodel import NeuralCF
...
if __name__ == "__main__":
    ...
    parser.add_argument('-train_path', action='store_true', default='/Users/jiangshan/Downloads/SparrowRecSys-master/src/main/resources/webroot/sampledata/trainingSamples.csv',
                        help='train data path')
    parser.add_argument('-test_path', action='store_true', default='/Users/jiangshan/Downloads/SparrowRecSys-master/src/main/resources/webroot/sampledata/data/raw/testSamples.csv',
                        help='test data path')
    parser.add_argument('-save_path', action='store_true', default='/Users/jiangshan/Downloads/SparrowRecSys-master/TFRecModel/src/com/sparrowrecsys/offline/pytorch/checkpoint/NeuralCF/NeuralCF_best.pth',
